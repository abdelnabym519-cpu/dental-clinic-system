...
const setupSections: SetupSection[] = [
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          ...
          'Fill in "Address": Street Address, City, Governorate, and Postal Code',
          'Fill in "Registration & Tax": Tax ID (الرقم الضريبي) and Commercial Register (السجل التجاري)',
          'Click "Save Changes"',
        ],
        tips: [
          'Tax ID format: 9 digits (e.g., 123456789)',
          'Commercial Register: 9 digits, issued by GAFI',
      ...
      {
        title: 'Add Bank & InstaPay Details',
        description: 'Add your bank account and InstaPay handle for payment collection.',
        steps: [
          'Go to Settings → Clinic Information, scroll to "Bank & Payment Details"',
          'Enter your Bank Name and Account Number (IBAN)',
          'Enter your InstaPay handle (e.g., yourclinic@instapay)',
          'Click "Save Changes"',
        ],
        tips: [
          'Bank details appear on invoices so patients can make bank transfers',
          'InstaPay transfers arrive instantly — reconcile them against invoice references',
        ],
        link: { label: 'Go to Clinic Settings', href: '/settings/clinic' },
      },
    ],
  ...
  },
  {
    ...
    description: 'Configure VAT, invoice format, and payment terms',
    icon: Receipt,
    ...
    guides: [
      {
        title: 'Set Up VAT Rates',
        description:
          'Configure the VAT (ضريبة القيمة المضافة) percentage for automatic tax calculation on invoices.',
        steps: [
          'Go to Settings → Billing Settings',
          'In the "Tax Configuration" section, enter your VAT Rate (standard: 14%)',
          'Click "Save Settings"',
        ],
        tips: [
          'Standard Egyptian VAT rate: 14%',
          'Medical services are generally VAT-exempt — set 0% if that applies to your clinic',
          'Tax is calculated automatically on every taxable invoice line',
        ],
  ...
  },
  {
    ...
    description: 'Accept online payments from patients via Fawry, Paymob, or InstaPay',
    icon: CreditCard,
    ...
    guides: [
      {
        title: 'Set Up Fawry',
        description:
          'Accept payments through the Fawry network — POS terminals, retail outlets, cards and mobile wallets.',
        steps: [
          "Create a Fawry merchant account if you don't have one",
          'Complete merchant onboarding and receive your Merchant Code and Secure Key',
          'In Dentora, go to Settings → Billing Settings → "Payment Gateway" tab',
          'Select "Fawry" as the provider',
          'Paste your Merchant Code and Secure Key',
          ...
          'Copy the Webhook URL shown and register it with Fawry support',
        ],
        tips: [
          'Always test with Test Mode ON first',
          'Fawry charges per-transaction fees that vary by channel (POS, retail, online)',
          'Keep your Secure Key safe — never share it publicly',
        ],
        link: { label: 'Go to Billing Settings', href: '/settings/billing' },
        externalLinks: [{ label: 'Fawry', url: 'https://fawry.com' }],
      },
      {
        title: 'Set Up Paymob (Accept)',
        description: 'Accept cards, wallets, and bank installments through Paymob hosted checkout.',
        steps: [
          'Create a Paymob account at accept.paymob.com',
          'Complete the business onboarding verification',
          'Once approved, create a "Payment Integration" for online checkout and note the Integration ID',
          'Note your Iframe ID from the Paymob dashboard',
          'In Dentora, go to Settings → Billing Settings → "Payment Gateway" tab',
          'Select "Paymob" as the provider',
          'Paste your API Key, Integration ID, and Iframe ID',
          'Toggle Test/Live mode appropriately',
          'Click "Save Gateway Settings"',
        ],
        tips: [
          'Paymob is one of the most widely used payment gateways in Egypt',
          'Register the shown Webhook URL in the Paymob dashboard to receive transaction callbacks',
        ],
        link: { label: 'Go to Billing Settings', href: '/settings/billing' },
        externalLinks: [{ label: 'Paymob Signup', url: 'https://accept.paymob.com' }],
      },
      {
        title: 'Set Up InstaPay',
        description: 'Receive instant bank transfers against your clinic InstaPay handle (IPA).',
        steps: [
          'Register your clinic bank account with InstaPay and get your InstaPay handle (e.g., clinic@instapay)',
          'In Dentora, go to Settings → Billing Settings → "Payment Gateway" tab',
          'Select "InstaPay" as the provider',
          'Enter your InstaPay handle',
          'Click "Save Gateway Settings"',
        ],
        tips: [
          'InstaPay transfers are instant and free for patients via their bank apps',
          'Patients see the payment reference on the pay page — reconcile transfers against it',
        ],
        link: { label: 'Go to Billing Settings', href: '/settings/billing' },
        externalLinks: [{ label: 'InstaPay', url: 'https://instapay.eg' }],
      },
    ],
  },
  {
    ...
    guides: [
      {
        title: 'Set Up SMS Gateway (Vodafone Business)',
        description:
          "Vodafone Egypt's business SMS service is the most widely used gateway for clinics.",
        steps: [
          'Contact Vodafone Business or your account manager to activate the SMS API service',
          'Request your API credentials (Bearer token) and approved Sender Name',
          'In Dentora, go to Settings → Communication Settings',
          'Toggle "Enable SMS" ON',
          'Select "VODAFONE" as the Gateway',
          'Paste your API key and approved Sender Name',
          'Click "Save Settings"',
          'Test by entering a phone number and clicking "Send Test SMS"',
        ],
        tips: [
          'SMS can only be sent between 9 AM - 9 PM Cairo time',
          'Patients who opted out of SMS will be skipped automatically',
          'SMS costs are billed monthly per message volume',
        ],
        link: { label: 'Go to Communication Settings', href: '/settings/communications' },
        externalLinks: [{ label: 'Vodafone Business Egypt', url: 'https://web.vodafone.com.eg' }],
      },
      {
        title: 'Set Up SMS Gateway (Etisalat / Orange)',
        description: 'Etisalat and Orange Egypt offer equivalent business SMS APIs.',
        steps: [
          'Activate the business SMS API with Etisalat or Orange Egypt',
          'Copy your API subscription key / bearer token',
          'In Dentora, go to Settings → Communication Settings',
          'Toggle "Enable SMS" ON',
          'Select "ETISALAT" or "ORANGE" as the Gateway',
          'Paste your API key and Sender Name',
          'Click "Save Settings"',
          'Send a test SMS to verify it works',
        ],
        tips: [
          'All Egyptian carriers enforce the 9 AM - 9 PM marketing window; transactional reminders are safest during it',
        ],
        link: { label: 'Go to Communication Settings', href: '/settings/communications' },
        externalLinks: [{ label: 'Etisalat Business', url: 'https://www.etisalat.com.eg' }],
      },
    ],
  },
  {
    ...
    guides: [
      {
        ...
        steps: [
          'In Dentora, go to Settings → Communication Settings → Email tab',
      ...
      },
      {
        ...
        steps: [
          ...
          'Select "Mail" as the app and "Other" as the device, name it "Dentora"',
          'Click "Generate" — Google will show a 16-character password. Copy it immediately!',
          'In Dentora Communication Settings:',
    ...
    guides: [
      {
        ...
        description: 'Sync your Dentora appointments to Google Calendar automatically.',
        steps: [
          ...
          'Grant Dentora permission to manage your calendar events',
    ...
    guides: [
      {
        ...
        steps: [
          ...
          'In Dentora, go to Settings → Communication Settings → "Google Reviews" tab',
    ...
    guides: [
      {
        ...
        description: "Dentora uses OpenRouter to power its AI features. You'll need an API key.",
        steps: [
          'Go to openrouter.ai and create a free account',
          'Click on your profile icon → "Keys" (or go to openrouter.ai/keys)',
          'Click "Create Key" and give it a name like "Dentora"',
          'Copy the API key (starts with "sk-or-")',
          'Add this key to your Dentora environment configuration:',
          "  — In your server's .env file, add: OPENROUTER_API_KEY=sk-or-your-key-here",
          '  — Restart the application after adding the key',
          'In Dentora, go to Settings → AI Features and toggle "Enable AI" ON',
        ],
        tips: [
          'OpenRouter provides access to multiple AI models at competitive prices',
          'Dentora uses cost-effective models — typical monthly cost is EGP 100-500 for a small clinic',
      ...
      },
      {
        ...
        steps: [
          ...
          'Set your Monthly AI Budget limit (e.g., EGP 500)',
          'Click "Save Settings"',
        ],
        tips: [
    ...
    guides: [
      {
        ...
        tips: [
          'Each device needs an API key to send data to Dentora',
    ...
    guides: [
      {
        ...
        tips: [
          ...
          'Phone numbers should be Egyptian mobile numbers (01XXXXXXXXX)',
