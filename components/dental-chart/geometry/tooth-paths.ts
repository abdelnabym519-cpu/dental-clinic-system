...
function getMaxillaryCentralIncisor(isRight: boolean): ToothGeometryPaths {
  return {
    ...
    crownDetails: [
      // Mamelon lobes & incisal translucency band
      'M 17,92 L 43,92',
      'M 25,62 C 25,74 24,84 24,94',
      'M 35,62 C 35,74 36,84 36,94',
    ],
...
function getMaxillaryLateralIncisor(isRight: boolean): ToothGeometryPaths {
  ...
  return {
    ...
    crownDetails: ['M 20,91 L 38,91', 'M 26,62 L 26,88', 'M 34,62 L 34,88'],
...
function getMaxillaryCanine(isRight: boolean): ToothGeometryPaths {
  return {
    ...
    rootDetails: ['M 28,10 L 28,44', 'M 32,10 L 32,44'],
    crownOutline: isRight
      ? 'M 16,48 C 13,60 13,76 18,87 L 30,97 L 42,85 C 47,76 47,60 44,48 Z'
      : 'M 16,48 C 13,60 13,76 18,85 L 30,97 L 42,87 C 47,76 47,60 44,48 Z',
    crownDetails: [
      // Prominent 3D Labial Ridge & Facet Lines
      'M 30,48 L 30,96',
      'M 20,70 L 30,95 L 40,70',
    ],
    ...
    surfaces: {
      ...
      occlusal: 'M 22,62 L 38,62 L 38,78 L 41,84 L 30,97 L 19,84 L 22,78 Z',
    },
    fissurePaths: ['M 30,50 L 30,92'],
    cuspHighlights: ['M 24,88 L 30,96 L 36,88'],
    ...
    crownCapOutline: 'M 14,48 C 11,60 11,78 16,88 L 30,97 L 44,88 C 49,78 49,60 46,48 Z',
    apexCenter: { x: 30, y: 4 },
    apices: [{ x: 30, y: 4 }],
    gumLinePath: 'M 13,48 Q 30,54 47,48',
    cervicalLinePath: 'M 16,48 Q 30,52 44,48',
    fractureCrackPath: 'M 18,50 L 28,68 L 24,76 L 30,97',
  }
}
...
function getMaxillaryFirstPremolar(isRight: boolean): ToothGeometryPaths {
  return {
    ...
    rootDetails: ['M 23,12 L 25,32', 'M 37,12 L 35,32'],
    crownOutline:
      'M 14,48 C 12,56 10,76 13,87 C 15,92 22,95 28,95 C 32,95 38,93 42,91 C 48,87 48,68 46,48 Z',
    crownDetails: [
      // 3D Buccal & Palatal Cusp Slopes
      'M 15,64 C 20,60 28,60 30,62 C 32,60 40,60 45,64',
      'M 20,80 C 28,84 32,84 40,80',
    ],
    pulpOutline: 'M 22,54 C 20,62 20,74 23,80 C 25,83 35,83 37,80 C 40,74 40,62 38,54 Z',
    rootCanalPaths: ['M 22,8 C 22,22 24,36 26,54', 'M 38,8 C 38,22 36,36 34,54'],
    surfaces: {
    ...
    fissurePaths: ['M 24,71 L 36,71', 'M 24,71 L 18,66', 'M 36,71 L 42,66'],
    cuspHighlights: ['M 20,65 L 28,62 L 36,65', 'M 22,78 L 28,80 L 34,78'],
    rootSeparationPath: 'M 30,32 L 30,48',
...
function getMaxillarySecondPremolar(isRight: boolean): ToothGeometryPaths {
  return {
    ...
    rootDetails: ['M 28,12 L 28,44', 'M 32,12 L 32,44'],
    crownOutline:
      'M 15,48 C 13,56 12,76 15,86 C 18,92 24,95 30,95 C 36,95 42,92 45,86 C 48,76 47,56 45,48 Z',
    crownDetails: ['M 18,63 C 24,61 36,61 42,63', 'M 20,79 C 26,81 34,81 40,79'],
    ...
    cuspHighlights: ['M 22,64 L 30,62 L 38,64', 'M 22,78 L 30,80 L 38,78'],
    implantOutline: 'M 20,48 L 40,48 L 38,16 C 38,12 34,8 30,8 C 26,8 22,12 22,16 Z',
...
function getMaxillaryFirstMolar(isRight: boolean): ToothGeometryPaths {
  return {
    ...
    rootDetails: ['M 15,12 L 20,34', 'M 30,8 L 30,36', 'M 45,12 L 40,34'],
    crownOutline:
      'M 8,48 C 6,56 5,76 7,88 C 9,94 16,97 30,97 C 44,97 51,94 53,88 C 55,76 54,56 52,48 Z',
    crownDetails: [
      // 4 Sculpted Cusp Facets & Oblique Ridge Contour
      'M 12,64 C 18,62 26,62 30,66',
      'M 30,66 C 34,62 42,62 48,64',
      'M 10,84 C 18,88 24,88 30,86',
      'M 30,86 C 36,88 42,88 50,84',
    ],
    pulpOutline: 'M 18,54 C 16,60 16,74 18,80 C 22,83 38,83 42,80 C 44,74 44,60 42,54 Z',
    rootCanalPaths: [
      'M 14,7 C 14,20 18,34 22,54',
      'M 30,4 C 30,20 30,34 30,54',
      'M 46,7 C 46,20 42,34 38,54',
    ],
    surfaces: {
    ...
    fissurePaths: ['M 20,72 L 40,72', 'M 30,64 L 30,80', 'M 22,66 L 38,78'],
    cuspHighlights: [
      'M 14,65 L 22,63 L 28,66',
      'M 32,66 L 38,63 L 46,65',
      'M 14,80 L 22,82 L 28,80',
      'M 32,80 L 38,82 L 46,80',
    ],
...
function getMaxillarySecondMolar(isRight: boolean): ToothGeometryPaths {
  return {
    ...
    rootDetails: ['M 18,12 L 22,34', 'M 30,9 L 30,36', 'M 42,12 L 38,34'],
    crownOutline:
      'M 10,48 C 8,56 7,76 9,87 C 11,93 18,96 30,96 C 42,96 49,93 51,87 C 53,76 52,56 50,48 Z',
    crownDetails: [
      'M 14,64 C 20,62 26,62 30,65',
      'M 30,65 C 34,62 40,62 46,64',
      'M 13,83 C 20,87 26,87 30,85',
      'M 30,85 C 34,87 40,87 47,83',
    ],
    ...
    cuspHighlights: [
      'M 16,65 L 22,63 L 28,66',
      'M 32,66 L 38,63 L 44,65',
      'M 16,79 L 22,81 L 28,79',
      'M 32,79 L 38,81 L 44,79',
    ],
...
function getMaxillaryThirdMolar(isRight: boolean): ToothGeometryPaths {
  ...
  return {
    ...
    rootDetails: ['M 28,16 L 28,44', 'M 32,16 L 32,44'],
    crownOutline:
      'M 12,48 C 10,56 9,76 11,86 C 13,92 20,95 30,95 C 40,95 47,92 49,86 C 51,76 50,56 48,48 Z',
    crownDetails: ['M 16,64 C 22,62 38,62 44,64', 'M 15,82 C 22,86 38,86 45,82'],
    ...
    cuspHighlights: [
      'M 18,64 L 24,62 L 29,64',
      'M 31,64 L 36,62 L 42,64',
      'M 20,78 L 30,80 L 40,78',
    ],
    implantOutline: 'M 20,48 L 40,48 L 38,16 C 38,12 34,8 30,8 C 26,8 22,12 22,16 Z',
    implantThreads: ['M 21,42 L 39,42', 'M 22,36 L 38,36', 'M 23,30 L 37,30', 'M 24,24 L 36,24'],
...
function getMandibularCentralIncisor(isRight: boolean): ToothGeometryPaths {
  return {
    ...
    crownDetails: ['M 22,9 L 38,9', 'M 26,14 L 26,38', 'M 34,14 L 34,38'],
    rootOutline: 'M 22,52 C 20,68 24,84 28,94 C 29,96 31,96 32,94 C 36,84 40,68 38,52 Z',
    rootDetails: ['M 30,58 L 30,88'],
...
function getMandibularLateralIncisor(isRight: boolean): ToothGeometryPaths {
  ...
  return {
    ...
    crownDetails: ['M 21,9 L 39,9', 'M 25,14 L 25,38', 'M 35,14 L 35,38'],
    rootOutline: isRight
...
function getMandibularCanine(isRight: boolean): ToothGeometryPaths {
  return {
    ...
    canalCount: 1,
    crownOutline: isRight
      ? 'M 17,52 C 15,40 14,24 18,13 L 30,3 L 42,15 C 46,24 45,40 43,52 Z'
      : 'M 17,52 C 15,40 14,24 18,15 L 30,3 L 42,13 C 46,24 45,40 43,52 Z',
    crownDetails: ['M 30,52 L 30,4', 'M 20,26 L 30,5 L 40,26'],
    rootOutline: 'M 19,52 C 17,68 21,84 28,95 C 30,97 32,97 34,95 C 41,84 43,68 41,52 Z',
    rootDetails: ['M 28,58 L 28,90', 'M 32,58 L 32,90'],
    ...
    cuspHighlights: ['M 24,10 L 30,4 L 36,10'],
    ...
    crownCapOutline: 'M 15,52 C 13,40 12,22 16,12 L 30,3 L 44,12 C 48,22 47,40 45,52 Z',
...
function getMandibularFirstPremolar(isRight: boolean): ToothGeometryPaths {
  return {
    ...
    canalCount: 1,
    crownOutline:
      'M 16,52 C 14,44 12,24 15,14 C 18,8 24,4 30,3 C 36,4 42,8 45,14 C 48,24 46,44 44,52 Z',
    crownDetails: [
      // Dominant Buccal Cusp Slope & Lingual Transverse Ridge ("Snake-eyes")
      'M 18,20 C 24,18 36,18 42,20',
      'M 20,38 C 26,40 34,40 40,38',
    ],
    rootOutline: 'M 18,52 C 16,68 18,84 26,93 C 28,95 32,95 34,93 C 42,84 44,68 42,52 Z',
    rootDetails: ['M 28,58 L 28,88', 'M 32,58 L 32,88'],
    ...
    fissurePaths: [
      'M 24,28 L 36,28',
      'M 24,28 A 1.5 1.5 0 1 0 24,28.1',
      'M 36,28 A 1.5 1.5 0 1 0 36,28.1',
    ],
    cuspHighlights: ['M 22,10 L 30,4 L 38,10'],
...
function getMandibularSecondPremolar(isRight: boolean): ToothGeometryPaths {
  return {
    ...
    crownDetails: ['M 18,20 C 24,18 36,18 42,20', 'M 18,36 C 24,38 36,38 42,36'],
    rootOutline: 'M 18,52 C 16,68 18,84 26,93 C 28,95 32,95 34,93 C 42,84 44,68 42,52 Z',
    rootDetails: ['M 28,58 L 28,88', 'M 32,58 L 32,88'],
    ...
    fissurePaths: ['M 24,25 L 36,25', 'M 30,25 L 30,37'],
    cuspHighlights: [
      'M 22,10 L 30,6 L 38,10',
      'M 20,34 L 25,36 L 29,34',
      'M 31,34 L 35,36 L 40,34',
    ],
    implantOutline: 'M 20,52 L 40,52 L 38,84 C 38,88 34,92 30,92 C 26,92 22,88 22,84 Z',
    implantThreads: ['M 21,58 L 39,58', 'M 22,64 L 38,64', 'M 23,70 L 37,70', 'M 24,76 L 36,76'],
...
function getMandibularFirstMolar(isRight: boolean): ToothGeometryPaths {
  return {
    ...
    crownDetails: [
      // 5 Sculpted 3D Cusp Facets
      'M 12,18 C 18,16 24,16 30,19',
      'M 30,19 C 36,16 42,16 48,18',
      'M 12,36 C 18,38 24,38 30,35',
      'M 30,35 C 36,38 42,38 48,36',
    ],
    rootOutline:
    ...
    rootDetails: ['M 18,60 L 16,84', 'M 42,60 L 44,84'],
    pulpOutline: 'M 18,46 C 16,40 16,26 18,20 C 22,17 38,17 42,20 C 44,26 44,40 42,46 Z',
    rootCanalPaths: ['M 16,92 C 16,78 20,64 24,46', 'M 44,92 C 44,78 40,64 36,46'],
    surfaces: {
    ...
    fissurePaths: ['M 18,28 L 42,28', 'M 24,14 L 24,36', 'M 36,14 L 36,36', 'M 44,18 L 38,28'],
    cuspHighlights: [
      'M 14,12 L 20,9 L 26,12',
      'M 26,12 L 32,9 L 38,12',
      'M 39,13 L 44,11 L 48,14',
      'M 14,36 L 22,38 L 29,36',
      'M 31,36 L 38,38 L 46,36',
    ],
    rootSeparationPath: 'M 30,64 L 30,52',
...
function getMandibularSecondMolar(isRight: boolean): ToothGeometryPaths {
  return {
    ...
    rootDetails: ['M 20,60 L 18,84', 'M 40,60 L 42,84'],
    crownOutline:
      'M 10,52 C 8,44 7,24 9,13 C 11,7 18,4 30,4 C 42,4 49,7 51,13 C 53,24 52,44 50,52 Z',
    crownDetails: [
      'M 14,18 C 20,16 26,16 30,18',
      'M 30,18 C 34,16 40,16 46,18',
      'M 14,36 C 20,38 26,38 30,36',
      'M 30,36 C 34,38 40,38 46,36',
    ],
    ...
    fissurePaths: ['M 18,28 L 42,28', 'M 30,14 L 30,38'],
    cuspHighlights: [
      'M 16,12 L 22,10 L 28,12',
      'M 32,12 L 38,10 L 44,12',
      'M 16,36 L 22,38 L 28,36',
      'M 32,36 L 38,38 L 44,36',
    ],
...
function getMandibularThirdMolar(isRight: boolean): ToothGeometryPaths {
  ...
  return {
    ...
    rootDetails: ['M 28,58 L 28,84', 'M 32,58 L 32,84'],
    crownOutline:
      'M 12,52 C 10,44 9,24 11,14 C 13,8 20,5 30,5 C 40,5 47,8 49,14 C 51,24 50,44 48,52 Z',
    crownDetails: ['M 16,18 C 22,16 38,16 44,18', 'M 16,36 C 22,38 38,38 44,36'],
    ...
    cuspHighlights: [
      'M 18,14 L 24,12 L 29,14',
      'M 31,14 L 36,12 L 42,14',
      'M 18,34 L 24,36 L 30,34',
      'M 32,34 L 37,36 L 42,34',
    ],
    implantOutline: 'M 20,52 L 40,52 L 38,84 C 38,88 34,92 30,92 C 26,92 22,88 22,84 Z',
    implantThreads: ['M 21,58 L 39,58', 'M 22,64 L 38,64', 'M 23,70 L 37,70', 'M 24,76 L 36,76'],
