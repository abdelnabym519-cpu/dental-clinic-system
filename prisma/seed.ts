...
async function main() {
    ...
    create: {
      ...
      staff: {
        create: {
          ...
          phone: '01001234567',
          email: 'admin@dentora-dental.com',
          specialization: 'إدارة عيادات الأسنان',
          licenseNumber: 'EG-ADM-2015-0001',
          city: 'القاهرة',
          state: 'القاهرة',
          hospitalId: hospital.id,
        },
    ...
    create: {
      ...
      staff: {
        create: {
          ...
          licenseNumber: 'EG-DENT-2012-3307',
          city: 'القاهرة',
          state: 'القاهرة',
          hospitalId: hospital.id,
        },
  ...
  for (let i = 0; i < patients.length; i++) {
    ...
    await prisma.patient.upsert({
      ...
      create: {
        ...
        city: 'القاهرة',
        state: 'القاهرة',
        address: `${15 + i} شارع التحرير، وسط البلد`,
        pincode: '11513',
        hospitalId: hospital.id,
        medicalHistory: {
          create: {
  ...
  const suppliers = [
    {
      code: 'SUP001',
      name: 'Cairo Dental Depot',
      contactPerson: 'محمود سعيد',
      phone: '01011112222',
      email: 'sales@cairodental.example',
      status: SupplierStatus.ACTIVE,
    },
    {
      code: 'SUP002',
      name: 'Nile Ortho Supplies',
      contactPerson: 'هدى فؤاد',
      phone: '01033334444',
      email: 'orders@nileortho.example',
      status: SupplierStatus.ACTIVE,
    },
    {
      code: 'SUP003',
      name: 'Delta Instruments Co',
      contactPerson: 'كريم شكري',
      phone: '01055556666',
  ...
  const doctorStaff = await prisma.staff.upsert({
    ...
    create: {
      ...
      specialization: 'طب الأسنان العام',
      licenseNumber: 'EG-DENT-2018-4471',
      city: 'القاهرة',
      state: 'القاهرة',
    },
  })
      ...
      create: {
        ...
        staff: {
          create: {
            ...
            licenseNumber: 'EG-DENT-2016-2210',
            city: 'القاهرة',
            state: 'القاهرة',
            hospitalId: hospital.id,
          },
