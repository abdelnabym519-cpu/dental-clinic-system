...
toPng(zoomSheet([46], 6), path.join(outDir, 'zoom-46.png'), 2400)
toPng(zoomSheet([44, 45], 4), path.join(outDir, 'zoom-44-45.png'), 2400)
toPng(zoomSheet([11, 21], 4), path.join(outDir, 'zoom-11-21.png'), 2400)
